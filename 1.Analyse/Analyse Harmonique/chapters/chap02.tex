...
In the previous chapter, we denote \(\mathcal{R}[-\pi, \pi]\) as the set of all Riemann integrable or
absolutely Riemann integrable functions on \([-\pi, \pi]\).
Now, for convenience, we introduce the notation \(\overline{\mathcal{R}}[-\pi, \pi]\) as the set of all 
Riemann integrable or square Riemann integrable functions on \([-\pi, \pi]\).
