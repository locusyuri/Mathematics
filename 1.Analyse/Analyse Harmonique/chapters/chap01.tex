...
\begin{description}
    \item[Set and Field] The linear space we are working on is the set of all integrable 
        (in the \emph{Riemann sense})\footnote{
            For common integral, it should be Riemann integral;
            for defective integral, it should be \emph{absolute Riemann integral}.
...
which is \emph{isomorphic} to the space of periodic functions \( f(x) \) with period \( 2\pi \).
