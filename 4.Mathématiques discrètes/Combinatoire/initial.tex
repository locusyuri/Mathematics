...
\version{0.1} % 这里放置版本号
% \institute{Mathématiques} % 这里放置机构名
...
\part{Basic Counting}
\input{chapters/chap01.tex} % 基本计数原理
% \input{chapters/chap02.tex} % 排列与组合      已合并入第一章
\input{chapters/chap03.tex} % 二项式系数

% --- Part 2: 进阶计数方法 (Advanced Counting) ---
\part{Advanced Counting}
\input{chapters/chap05.tex} % 递推关系与生成函数
\input{chapters/chap04.tex} % 容斥原理
\input{chapters/chap06.tex} % 特殊计数序列

% --- Part 3: 存在性与极值 (Existence and Extremal) ---
\part{Existence and Extremal}
\input{chapters/chap07.tex} % 鸽巢原理
\input{chapters/chap08.tex} % 极值原理
\input{chapters/chap09.tex} % Ramsey 理论

% --- Part 4: 结构与代数 (Structure and Algebra) ---
\part{Structure and Algebra}
\input{chapters/chap10.tex} % 组合设计
\input{chapters/chap11.tex} % Pólya 计数




\begin{thebibliography}{99} 
\bibitem{en1} Richard A. Brualdi. \emph{Introductory Combinatorics 5th Edition}. 机械工业出版社, 2012.
\end{thebibliography}
