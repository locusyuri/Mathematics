...
\begin{table}[h]
    ...
    \begin{tabular}{ccp{12cm}}
        ...
        1.0 & January, 2026 & Basic content completed, including chapters on determinants, 
            systems of linear equations, matrices, vector spaces, linear mappings, diagonalization, 
            Jordan normal form, quadratic forms, and inner product spaces. \\
        \bottomrule
    \end{tabular}
\end{table}
